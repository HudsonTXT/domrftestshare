...
#domrf, #domrf450, #домрф, #450тысяч, #гасимипотеку, #гасимипотеку450 
    ...
    function buttonClicked (e) {
        ...
        const share = new Share(SHARE_DATA.url, SHARE_DATA.title, SHARE_DATA.img, (shareType === 'ok' ? SHARE_DATA.longText:SHARE_DATA.text));
        share[shareType]();
    }
}
...
function Share(purl, ptitle, pimg, text) {
    ...
    */
    ...
    this.vk = function () {
        var url  = 'https://oauth.vk.com/authorize?client_id=7629067&scope=wall,photos&display=popup&v=5.124&response_type=token&redirect_uri=' + window.location;
        window.location = url;
    };
